            ...
            if (i < stepCount)
              return (
                <Step
                  ...
                  description={` ${language.steps_page_item_right} ${
                    statistics[i].filter((e) => e.answer === true).length
                  } ${language.steps_page_item_wrong} ${
                    statistics[i].filter((e) => e.answer === false).length
                  }`}
                />
              );
            else if (i === stepCount)
